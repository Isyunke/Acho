package com.acho.community.service;

import com.acho.community.dao.UserMapper;
import com.acho.community.entity.LoginTicket;
...
import com.acho.community.util.MailClient;
...
public class UserService implements CommunityConstant {
    ...
    public Map<String, Object> register(User user) {
        ...
        mailClient.sendMail(user.getEmail(),"激活 Acho 账号", content);
